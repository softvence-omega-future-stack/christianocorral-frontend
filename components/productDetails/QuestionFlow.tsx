            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
              {[
                ...
                <button
                  ...
                  className={`flex-1 min-w-[120px] px-2 py-2 rounded-lg border-2 text-sm font-medium transition-all ${
                ...
                {answers.condition === "Sealed" && (
                  <>
                    <p className="font-semibold">
                      DEVICE IS UNOPENED AND SEALED IN ORIGINAL RETAIL
                      PACKAGING.
                    </p>
